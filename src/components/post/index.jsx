...
export default function Post({ img, value }) {
  ...
  return (
    <div className="px-4 py-3 z-[-5] gap-3 border-b border-[color:var(--background-third)]  relative before:absolute before:z-[-1] before:transition-colors before:opacity-50 before:inset-0 before:hover:bg-[color:var(--background-secondary)]">
      <div className="flex ">
        <img
          src={account.avatar}
